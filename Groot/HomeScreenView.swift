...
struct HomeScreenView: View {
    ...
    let allProducts: [Product] = [
        Product(name: "Gurkhas Restaurant", imageName: "gurkhas", distance: 3.5, hours: "11:00 am to 12:00 am", rating: 4, price: "$", category: .restaurants),
        Product(name: "Momo Central", imageName: "momoCentral", distance: 4.7, hours: "10:00 am to 11:00 pm", rating: 5, price: "$$", category: .restaurants),
        
        Product(name: "Nepalese Grocery", imageName: "nepaleseGrocery", distance: 2.0, hours: "9:00 am to 9:00 pm", rating: 4, price: "$", category: .grocery),
        Product(name: "Green Grocers", imageName: "greenGrocers", distance: 1.5, hours: "8:00 am to 8:00 pm", rating: 5, price: "$", category: .grocery),
        Product(name: "Organic Foods", imageName: "organicFoods", distance: 3.8, hours: "7:30 am to 9:00 pm", rating: 4, price: "$$", category: .grocery),
        Product(name: "Daily Needs", imageName: "dailyNeeds", distance: 4.0, hours: "8:00 am to 10:00 pm", rating: 3, price: "$", category: .grocery),
        
        Product(name: "Nepa Fashion House", imageName: "nepaFashion", distance: 5.1, hours: "10:00 am to 9:00 pm", rating: 3, price: "$$", category: .clothing),
        Product(name: "Urban Trends", imageName: "urbanTrends", distance: 3.3, hours: "9:00 am to 8:00 pm", rating: 5, price: "$$", category: .clothing),
        Product(name: "Vintage Wear", imageName: "vintageWear", distance: 6.5, hours: "11:00 am to 7:00 pm", rating: 4, price: "$$$", category: .clothing),
        
        Product(name: "My Dream Travels", imageName: "myDreams", distance: 8.0, hours: "8:00 am to 10:00 pm", rating: 5, price: "$$$", category: .travel),
        Product(name: "Adventure Awaits", imageName: "adventureAwaits", distance: 12.0, hours: "6:00 am to 10:00 pm", rating: 5, price: "$$$", category: .travel),
        Product(name: "Global Journeys", imageName: "globalJourneys", distance: 15.3, hours: "24/7", rating: 4, price: "$$$", category: .travel),
    ]
...
// Define a view for the detail of each product
struct ProductDetailView: View {
    var product: Product
    
    var body: some View {
        Text(product.name) // Detailed view goes here
    }
}
